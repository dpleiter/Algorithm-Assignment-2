...
public abstract class SudokuGrid {
     ...
     *
     * @param filename Filename of the file containing the intial configuration of
     *                 the grid we will solve.
     *
     * @throws FileNotFoundException If filename is not found.
     * @throws IOException           If there are some IO exceptions when openning
     *                               or closing the files.
     */
